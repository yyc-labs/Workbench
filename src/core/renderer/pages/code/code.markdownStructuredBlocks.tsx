...
export function getSourceLineDataProps(
...
export function createSourceTrackedBlockComponent<TagName extends keyof JSX.IntrinsicElements>(
  tagName: TagName,
  lineOffset: number
...
export function shouldIgnoreStructuredBlockActivation(
...
function buildStructuredBlockInteractiveProps(
  structuredBlockKind: MarkdownStructuredBlockKind,
...
export function createStructuredBlockComponent<TagName extends 'div' | 'table'>(
  tagName: TagName,
  lineOffset: number,
  ...
  return function StructuredMarkdownBlock({
    ...
    const { ariaLabel, resolvedTitle, sharedProps } = buildStructuredBlockInteractiveProps(
      structuredBlockKind,
