export const learningMessages = {
  'en-US': {
    learning: {
      ...
      toolbar: { viewLabel: 'Learning view', browserAiPreferences: 'Browser AI preferences', browserScreenshot: 'Capture a long screenshot of the browser page' },
      browserScreenshot: {
        kicker: 'Browser capture',
        title: 'Long screenshot',
        description: 'Capture the selected managed browser tab as one continuous image.',
        target: 'Browser tab',
        url: 'Website URL',
        urlPlaceholder: 'Enter a URL to capture, or choose a browser tab below',
        fixedPolicy: 'Floating elements',
        captureMode: 'Capture mode',
        standardMode: 'Standard full-page capture',
        preciseMode: 'Precise container capture',
        keepFixed: 'Keep page elements',
        hideFixed: 'Hide fixed and sticky elements',
        noTargets: 'No browser tabs found',
        refreshTargets: 'Refresh browser tabs',
        loadFailed: 'Could not load browser tabs.',
        running: 'Capturing browser page...',
        failed: 'Browser screenshot failed.',
        copyFailed: 'Could not copy the screenshot.',
        copySuccess: 'Copied to clipboard',
        preview: 'Long screenshot preview',
        viewImage: 'View image',
        completed: 'Image size: {value}',
        copy: 'Copy image',
        save: 'Save image',
        saveSuccess: 'Image saved',
        openDefault: 'Open in image viewer',
        openDefaultFailed: 'Could not open the system image viewer.',
        openViewerFailed: 'Could not open the screenshot viewer.',
      ...
      skills: {
        ...
        copyContent: 'Copy skill content',
        contentCopied: 'Skill content copied',
  ...
  'zh-CN': {
    learning: {
      ...
      toolbar: { viewLabel: '学习中心视图', browserAiPreferences: '浏览器 AI 偏好设置', browserScreenshot: '截取浏览器网页长图' },
      browserScreenshot: {
        kicker: '浏览器截图',
        title: '网页长截图',
        description: '将选中的受控浏览器标签页截取为一张连续图片。',
        target: '浏览器标签页',
        url: '网页地址',
        urlPlaceholder: '输入网址直接截图，或在下方选择浏览器标签页',
        fixedPolicy: '悬浮元素',
        captureMode: '截图方式',
        standardMode: '普通整页截图',
        preciseMode: '精准容器截图（浏览器内选择）',
        keepFixed: '保留页面元素',
        hideFixed: '隐藏 fixed 和 sticky 元素',
        noTargets: '没有找到浏览器标签页',
        refreshTargets: '刷新浏览器标签页',
        loadFailed: '浏览器标签页加载失败。',
        running: '正在截取网页...',
        failed: '网页截图失败。',
        copyFailed: '截图复制失败。',
        copySuccess: '已复制到剪贴板',
        preview: '网页长截图预览',
        viewImage: '查看图片',
        completed: '图片尺寸：{value}',
        copy: '复制图片',
        save: '保存图片',
        saveSuccess: '图片已保存',
        openDefault: '用系统图片工具打开',
        openDefaultFailed: '无法打开系统图片工具。',
        openViewerFailed: '无法打开截图查看窗口。',
        backToCapture: '返回截图小窗',
        cancel: '取消',
        start: '开始截图',
      },
      browserAi: {
      ...
      skills: {
        ...
        contentLabel: '指令正文',
        copyContent: '复制 Skill 内容',
        contentCopied: 'Skill 内容已复制',
