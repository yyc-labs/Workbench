...
export function RunCommandConfigPopover({
  ...
  return (
    <ModalShell
      ...
      panelClassName="max-h-[calc(100vh-56px)] overflow-hidden p-0"
    >
      <div className="flex max-h-[calc(100vh-56px)] min-h-0 flex-col">
        ...
        <div className="min-h-0 flex-1 overflow-auto px-5 py-3.5">
          {error && (
            <div className="mb-3 rounded-[12px] border border-[color:var(--color-destructive)]/30 bg-[color:var(--color-destructive-background)] px-3 py-2 text-xs text-[color:var(--color-destructive)]">
              {error}
            </div>
          )}

          <div className="mb-3 inline-flex rounded-full p-1 quiet-control">
            <button
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="quiet-control h-[108px] w-full resize-y rounded-[12px] border-0 px-3 py-2 font-mono text-[12px] text-[color:var(--color-foreground)] outline-none focus-visible:ring-2 focus-visible:ring-ring"
              ...
              <div className="max-h-[420px] overflow-y-auto pr-1">
                <div className="grid gap-1.5 sm:grid-cols-2">
                  {templates.map((item) => (
                    <button
                      key={item.id}
                      className="w-full rounded-[12px] border px-3 py-1.5 text-left transition-colors hover:bg-[color:var(--color-accent)]"
                    ...
                    >
                      <div className="flex min-w-0 items-start justify-between gap-2">
                        ...
                        <span className="max-w-[46%] shrink-0 text-right">
                          <span className="block truncate text-[10px] text-[color:var(--color-muted-foreground)]">{item.hint}</span>
