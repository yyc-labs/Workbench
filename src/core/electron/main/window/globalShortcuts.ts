...
export function registerGlobalShortcuts(onHomeShortcut: () => void, onThemeShortcut: () => void, onTranscriptCaptureShortcut: () => void, onBrowserScreenshotShortcut: () => void): void {
