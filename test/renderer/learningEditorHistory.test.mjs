...
const { createLearningEditorHistoryState, pushLearningEditorSnapshot, updateLearningEditorSnapshotSelection } = loadTsModule('src/core/renderer/pages/learning/notes/learningEditorHistory.ts')
...
test('preserves the pre-edit caret position for the first undo snapshot', () => {
  ...
  state = pushLearningEditorSnapshot(
    state,
    {
      value: '第一行X\n第二行',
      selectionStart: 5,
