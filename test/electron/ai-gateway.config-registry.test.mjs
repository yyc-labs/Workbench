...
test('normalizes provider capability defaults by upstream protocol', () => {
  ...
  assert.equal(config.providers[0].capabilities.nativeResponsesTools, false)
  assert.equal(config.providers[0].capabilities.responsesToolsViaChatDowngrade, true)
  assert.equal(config.providers[0].capabilities.responsesBuiltInTools, false)
  ...
  assert.equal(config.providers[1].capabilities.nativeResponsesTools, true)
  assert.equal(config.providers[1].capabilities.responsesToolsViaChatDowngrade, false)
  assert.equal(config.providers[1].capabilities.responsesBuiltInTools, false)
